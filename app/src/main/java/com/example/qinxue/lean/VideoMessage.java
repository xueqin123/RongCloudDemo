...
public class VideoMessage extends MediaMessageContent {
    ...
    private VideoMessage(Uri thumbUri, Uri localUri, int duration) {
        mThumbUri = thumbUri;
     ...
     */
    public static VideoMessage obtain(Uri thumbUri, Uri localUri, int duration) {
        return new VideoMessage(thumbUri, localUri, duration);
    }
